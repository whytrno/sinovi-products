...
export default function Footer() {
    return (
        <>
            <div className="px-10 sm:px-20 2xl:px-60 py-20 w-full bg-slate-100 space-y-5">
            ...
            <div className="bg-[#EA3337] w-full py-10">
                <p className="text-center text-lg font-semibold text-white">© 2023 Sentra Inovasi. All Rights Reserved</p>
            </div>
        </>
    )
}